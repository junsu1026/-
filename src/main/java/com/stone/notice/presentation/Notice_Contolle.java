...
//			mv.addObject("isWriter", 로그인회원과게시물작성자가동일인물);
	  ...
	  ModelAndView prepareForChange(@PathVariable int noticeNo, HttpSession session){
	  ...
	  ModelAndView change(Notice notice) {
	  ...
	  ModelAndView delete(@PathVariable int noticeNo, HttpSession session){ 
