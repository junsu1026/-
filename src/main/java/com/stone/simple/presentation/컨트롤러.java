...
import com.stone.simple.checklist.service.체크리스트관리자;
import com.stone.simple.common.VillageWeather;
import com.stone.simple.service.지역서비스;
...
//			mv.addObject("지역", 도시.getLname());
	...
	@GetMapping("/main3")
	public ModelAndView 메인3페이지로가다(HttpSession session) {
		ModelAndView mv = new ModelAndView();
