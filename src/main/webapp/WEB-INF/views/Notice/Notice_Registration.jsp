...
<div class="notice">
<div class="tab">
<span class="tab_btn active">새 공지사항 작성 <i class="ico_new"></i></span></div>
<div class="tab_each" style="display: block;">
				<form class="inquiry" action="/notice"  method="post">
          
   <p> 제목</p><p class="inp_wrap"><input type="text" name="title" placeholder="필수로 입력해주세요"  /> </p><br>
   <p>공지사항 내용</p><textarea cols="25" rows="5" name="contents"  placeholder="필수로 입력해주세요" ></textarea><br>
