...
<%
	TourBoard tourboard = (TourBoard) request.getAttribute("tourboards");
...
<section class="SubhomeThemedItems_container__2BOx-">
	...
	<nav class="SubhomeThemedItems_nav__fqPbx">
		...
		<span class="SubhomeThemedItems_navItemName__1ZZhb SubhomeThemedItems_navItemActive__3ulAC"> TourList </span>
...
<div class="container" style="width: 50%; height: 80%;">
 ...
 <div class="input-group mb-3">
    <span class="input-group-text">제목</span>
     <input type="text" class="form-control" name="title"value="<%=tourboard.getTitle()%>"  >
  
    <span class="input-group-text">작성자</span>
    <input type="text" class="form-control" name="writer"value="<%=tourboard.getWriter().getName() %>"style="background-color: white;" disabled>
  </div>

   <div class="input-group mb-3" style="border: solid 1px #ced4da;border-radius:5px; ">
    <span class="input-group-text">내용</span>
    <textarea class="form-control" rows="5" id="contents" name="contents" style="border: 0;resize: none;">
    	<%=tourboard.getContents()%>
    </textarea>
  </div>
<input type="submit" style="float: right;" class="btn btn-outline-info" value="저장">
 </form>
	<button type="reset" style="float: left;" class="btn btn-outline-info" onclick="location.href='/boards/1'" > 목록 </button>

 <button style="float: right;" class="btn btn-outline-info" onclick="location.href='/boards/1'" > 취소  </button>
 </div>
