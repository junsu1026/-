...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   pageEncoding="UTF-8"%>
   <% Member member = (Member) request.getAttribute("user_id") ;%>
<!DOCTYPE html>
<html>
<head>
...
<section class="SubhomeThemedItems_container__2BOx-">
	...
	<nav class="SubhomeThemedItems_nav__fqPbx">
		...
		<span class="SubhomeThemedItems_navItemName__1ZZhb SubhomeThemedItems_navItemActive__3ulAC"> 랜선투어 </span>
...
<form action="/tourboard" method="post">
<div class="container mt-3">

<div class="container" style="width: 100%;float: left; padding:0; left:-7%; margin-bottom:1%;">
<input type="hidden" name="type" >
<table>
<tr>
<td>
<select name="tourlocal" class="form-control" style="width: 200px;">
<option selected value="고성군">고성군</option>
<option value="속초시">속초시</option>
<option value="양양군">양양군</option>
<option value="강릉시">강릉시</option>
<option value="동해시">동해시</option>
<option value="삼척시">삼척시</option>
<option value="인재군">인재군</option>
<option value="양구군">양구군</option>
<option value="홍천구">홍천군</option>
<option value="철원군">철원군</option>
<option value="화천군">화천군</option>
<option value="춘천군">춘천군</option>
