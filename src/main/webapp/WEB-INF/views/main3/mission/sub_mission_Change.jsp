...
<%@page import="com.stone.member.common.Member"%>
    <%
   Mission mission= (Mission) request.getAttribute("missions");
...
<div class="notice">
<div class="tab">
<span class="tab_btn active">미션 클리어 인증 수정 <i class="ico_new"></i></span></div>


<div class="tab_each" style="display: block;">
				<form class="inquiry" action="/mission_update/update" enctype="multipart/form-data" method="post">
          
           <input type="hidden" name="no" value="${missions.no }"  /><br>
       <p>제목</p><p class="inp_wrap"><input type="text" name="title"  value="${missions.title }" /> </p><br>
      <p>클리어 내용</p><textarea cols="25" rows="5" name="contents"   >${missions.contents }"</textarea><br>
     
  
   			 <div class="filebox"><p>인증사진!</p>
   	 <%if(mission.getProfile()!=null){ %>
    <div class="filebox" style="float: left; margin-right: 10px; ">
    <p>업로드된사진</p>
    <img src="data:/png;base64,<%=Base64.encodeBytes(mission.getProfile())%>" width="200" height="200"/>
</div>
<%}%>
</div>
 <div class="filebox"><p>변경할사진!</p>
  <img id="profile" src="/img/빈화면.png" width="200" height="200"><br>
 <label for="profileFile" class="profileFile_but">사진업로드</label>
     <input type="file" name="profileFile" id="profileFile" class="btu_fill"  style="display:none">
</div><br>
