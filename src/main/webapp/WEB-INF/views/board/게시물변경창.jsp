...
<%
	Board board = (Board) request.getAttribute("boards");
...
<div class="container" style="width: 50%; height: 80%;">
 ...
 <div class="input-group mb-3">
    ...
    <input type="text" class="form-control" name="writer"value="<%=board.getWriter().getName() %>"style="background-color: white;" disabled>
  </div>
